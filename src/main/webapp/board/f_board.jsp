...
<html>
	<head>
		<meta charset="UTF-8">
		<title>자유 게시판</title>
		<link rel="stylesheet" href="../css/f_board.css" type="text/css">
	...
	<body>
		<%
			...
			String db_id = "root";
			String db_pw = "1234";
			String sql = "select*from board inner join user on board.u_no = user.u_no where b_category = 'B' order by b_no desc;";	
			int i = 1;
